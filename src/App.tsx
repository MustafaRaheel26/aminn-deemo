...
function MainAppContent() {
  ...
  useEffect(() => {
    ...
    if (currentUser) {
      if (currentPath === '#/login' || currentPath === '' || currentPath === '#/') {
        const target = currentUser.role === 'super_admin' 
          ? '#/super-dashboard' 
  ...
  return (
    <div className="flex bg-slate-50 min-h-screen text-slate-800" id="main-saas-layout">
      {/* SaaS Left Sidebar Navigation Drawer */}
