...
export default function AddProductModal({
  ...
  const imagePresets = [
    {
      name: "Adana Charcoal Kebab",
      url: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&auto=format&fit=crop",
    },
    {
      name: "Craft Cheeseburger Roll",
      url: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&auto=format&fit=crop",
    },
    {
      name: "Golden Shaved Döner",
      url: "https://images.unsplash.com/photo-1561651823-34fed022540d?w=600&auto=format&fit=crop",
    },
    {
      name: "Crispy Fried Chicken Bucket",
      url: "https://images.unsplash.com/photo-1569058242253-92a9c755a0ec?w=600&auto=format&fit=crop",
    },
    {
    ...
    {
      name: "Hot Roasted Espresso",
      url: "https://images.unsplash.com/photo-1497515114629-f71d768fd07c?w=600&auto=format&fit=crop",
    },
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!price || parseFloat(price) <= 0)
      return setError("Please specify a positive menu price.");
  ...
  return (
    <div
      className="fixed inset-0 bg-slate-900/60 backdrop-blur-md z-50 flex items-center justify-center p-4 shadow-sm"
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              {imagePresets.map((img, idx) => (
                <button
                  ...
                  className={`border p-1.5 rounded-lg text-left hover:border-[#EA580C]/40 hover:bg-white transition-all flex items-center gap-2 ${imageUrl === img.url ? "border-[#EA580C] bg-orange-50/60" : "border-slate-200 bg-white"}`}
                >
                  <img
