...
export default function Header({ onToggleSidebar }: HeaderProps) {
  ...
  const activeRestaurantObj = restaurants.find(
    (r) => r.id === activeRestaurantId,
  );

  return (
    <header
      className="bg-white border-b border-slate-200 h-16 px-6 lg:px-8 flex items-center justify-between sticky top-0 z-40 shadow-sm"
      id="main-header"
    >
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className="lg:hidden inline-flex items-center justify-center rounded-full p-2 bg-slate-100 text-slate-700 hover:bg-slate-200 transition-all"
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:flex items-center gap-5 text-xs text-slate-400 pr-4 border-r border-slate-200">
          ...
          <span className="flex items-center gap-1.5 font-mono">
            <Radio className="h-3.5 w-3.5 text-[#EA580C] animate-pulse" />9
            Screens Pushing
          </span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative group">
            <button
              className="flex items-center focus:outline-none focus:ring-2 focus:ring-[#EA580C]/40 rounded-full transition-all"
              id="header-user-menu"
            >
              <img
                ...
                src={
                  ...
                  "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=50&auto=format&fit=crop"
                }
                alt="Profile Avatar"
