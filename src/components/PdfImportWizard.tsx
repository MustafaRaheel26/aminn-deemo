...
export default function PdfImportWizard({
  ...
  const simulationPresets = {
    miracleOld: {
      ...
      categories: [
        {
          name: "Kebabs & Grills",
          explanation: "Found 4 menu titles in bold top header",
        },
        {
          name: "Cold Mezes",
          explanation: "Found 3 items with cumin and yogurt descriptors",
        },
        {
          name: "Fresh Craft Drinks",
          explanation: "Discovered coffee & tea line items",
        },
      ],
      products: [
        {
          name: "Adana Meatball Kebab",
          description:
            "Hand-ground spicy minced lamb spiced with fresh flat parsley and red chili peppers",
          price: 18.0,
          categoryId: "Kebabs & Grills",
          imageUrl:
            "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&auto=format&fit=crop",
        },
        {
          name: "Urfa Mild Lamb Skewer",
          description:
            "Tender non-spicy lamb skewered and char-grilled over premium wood coal embers",
          price: 19.5,
          categoryId: "Kebabs & Grills",
          imageUrl:
            "https://images.unsplash.com/photo-1603360946369-dc9bb6258143?w=600&auto=format&fit=crop",
        },
        {
          name: "Garlic Yogurt Cacik",
          description:
            "Chilled strained yogurt folded with cucumber shreds, fresh garlic cloves, and extra virgin mint oil",
          price: 7.5,
          categoryId: "Cold Mezes",
          imageUrl:
            "https://images.unsplash.com/photo-1541658016709-82535e94bc69?w=600&auto=format&fit=crop",
        },
        {
          name: "Stuffed Vine Leaves",
          description:
            "Grandma recipe hand-wrapped grape leaves stuffed with organic pine nuts, sweet black currants, and aromatic rice",
          price: 9.0,
          categoryId: "Cold Mezes",
          imageUrl:
        ...
        {
          name: "Double Steamed Espresso",
          description:
            "High-pressure shot of roasted Ethiopian dark bean blend",
          price: 5.0,
          categoryId: "Fresh Craft Drinks",
          imageUrl:
            "https://images.unsplash.com/photo-1497515114629-f71d768fd07c?w=600&auto=format&fit=crop",
        },
      ],
    },
    burgerWingsdiner: {
      ...
      categories: [
        {
          name: "Crispy Combos",
          explanation: "Identified from bucket keyword layouts",
        },
        {
          name: "Mega Sides",
          explanation: "Identified after french fries & waffle items",
        },
      ],
      products: [
        {
          name: "12pc Spicy Cajun Wings Bucket",
          description:
            "Double breaded deep fried wings tossed in cajun and smoke dust",
          price: 16.99,
          categoryId: "Crispy Combos",
          imageUrl:
            "https://images.unsplash.com/photo-1608039829572-78524f79c4c7?w=600&auto=format&fit=crop",
        },
        {
          name: "Golden Onion Ring Basket",
          description:
            "Oversized buttermilk soaked battered Spanish onion rings crispy breading",
          price: 6.99,
          categoryId: "Mega Sides",
          imageUrl:
  ...
  const handleUploadClick = (presetType: "miracleOld" | "burgerWingsdiner") => {
    ...
    setTimeout(() => {
      setProcessingStatus(
        "Structuring content (Multi-Tenant Vision Parser v3.1)...",
      );
      setTimeout(() => {
      ...
      <div className="bg-white rounded-2xl border border-slate-200 w-full max-w-4xl shadow-2xl relative overflow-hidden flex flex-col my-8">
        ...
        <div className="bg-[#EA580C] text-white p-6 relative">
          ...
          <p className="text-orange-50 text-xs mt-1">
            Bulk onboard menu contents dynamically. Upload a vintage flyer,
            standard PDF menu, or chalkboard layout and let our AI categorize
            and generate items for screens.
          </p>
        </div>
        ...
        <div className="bg-slate-50 border-b border-slate-100 px-6 py-4 flex items-center justify-between text-xs">
          <div className="flex items-center gap-6 overflow-x-auto w-full max-w-3xl pr-2 no-scrollbar">
            <div
              className={`flex items-center gap-1.5 font-semibold shrink-0 ${step >= 1 ? "text-[#EA580C]" : "text-slate-400"}`}
            >
              <div
                className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] ${step >= 1 ? "bg-[#EA580C] text-white font-mono" : "bg-slate-200 text-slate-500"}`}
              >
                1
              </div>
            ...
            <div
              className={`flex items-center gap-1.5 font-semibold shrink-0 ${step >= 2 ? "text-[#EA580C]" : "text-slate-400"}`}
            >
              <div
                className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] ${step >= 2 ? "bg-[#EA580C] text-white font-mono" : "bg-slate-200 text-slate-500"}`}
              >
                2
              </div>
            ...
            <div
              className={`flex items-center gap-1.5 font-semibold shrink-0 ${step >= 3 ? "text-[#EA580C]" : "text-slate-400"}`}
            >
              <div
                className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] ${step >= 3 ? "bg-[#EA580C] text-white font-mono" : "bg-slate-200 text-slate-500"}`}
              >
                3
              </div>
            ...
            <div
              className={`flex items-center gap-1.5 font-semibold shrink-0 ${step === 4 ? "text-emerald-700" : "text-slate-400"}`}
            >
              <div
                className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] ${step === 4 ? "bg-emerald-600 text-white font-mono" : "bg-slate-200 text-slate-500"}`}
              >
                4
              </div>
              <span>Complete!</span>
                  ...
                  >
                    <div className="border-2 border-dashed border-slate-200 hover:border-[#EA580C]/40 transition-all rounded-xl p-8 bg-slate-50/50 flex flex-col items-center justify-center text-center cursor-pointer relative group">
                      ...
                      <h4 className="text-sm font-bold text-slate-900 mb-1">
                        Drag and Drop PDF Menu
                      </h4>
                      <p className="text-xs text-slate-400 max-w-xs font-light">
                        Supports vector PDF, raw camera images, and historical
                        flyers (max 10MB)
                      </p>

                      <div className="mt-4 flex gap-2">
                        <span className="bg-white border border-slate-200 text-slate-500 text-[10px] px-2.5 py-1 rounded-md font-mono">
                          FILE.pdf
                        </span>
                        <span className="bg-white border border-slate-200 text-slate-500 text-[10px] px-2.5 py-1 rounded-md font-mono">
                          JPG / PNG
                    ...
                    <div>
                      <div className="flex items-center gap-1 text-xs text-slate-600 font-bold uppercase tracking-wider mb-3">
                        ...
                        <span>
                          Interactive Demo: Simulation Presets (No real files
                          needed!)
                        </span>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        >
                          ...
                          <div>
                            <span className="font-bold text-slate-800 text-xs block group-hover:text-[#EA580C]">
                              Miracle Archive Menu
                            </span>
                            <span className="text-[10px] font-mono text-slate-400 block mt-0.5">
                              Filename: miracle_menu_original_2025.pdf
                            </span>
                            <span className="text-[11px] text-slate-500 block mt-1.5 font-sans font-light leading-relaxed">
                              Scans 5 items in 3 custom categories: Kebabs, Meze
                              plates, and hot Turkish tea.
                            </span>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <span className="text-[11px] text-slate-500 block mt-1.5 font-sans font-light leading-relaxed">
                              Instantly imports fried wings & side rings baskets
                  ...
                  >
                    <div className="flex items-center gap-2 bg-emerald-50 border border-emerald-200 p-3.5 rounded-xl text-emerald-800 text-xs shadow-sm">
                      ...
                      <div>
                        <span className="font-bold text-emerald-950">
                          Neural Schema Extraction Complete!
                        </span>
                        <p className="text-[11px] text-emerald-700/90 mt-0.5">
                          Our deep learning model scanned{" "}
                          <b>{detectedProducts.length} items</b> and detected{" "}
                          <b>{detectedCategories.length} logical categories</b>{" "}
                          inside <i>{selectedFile}</i>.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <span className="text-xs uppercase font-semibold text-slate-500 block">
                        Configure Extracted Categories
                      </span>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        {detectedCategories.map((cat, idx) => (
                          <div
                            key={idx}
                            className="bg-slate-50 border border-slate-200 rounded-xl p-3 flex flex-col justify-between shadow-sm"
                          >
                            <div>
                              <div className="flex items-center justify-between">
                                ...
                                <span className="text-[10px] font-mono text-emerald-600 font-bold bg-emerald-50 border border-emerald-100 px-1.5 rounded">
                                  98% Conf
                                </span>
                              </div>
                            ...
                            <div className="mt-3 pt-2.5 border-t border-slate-200 flex items-center gap-1">
                              ...
                              <span className="text-[10px] font-bold text-[#EA580C] bg-orange-50 border border-orange-100 px-1.5 py-0.5 rounded uppercase font-mono">
                                Menu Board
                              </span>
                            </div>
                          </div>
                    ...
                    <div className="flex items-center gap-1.5 bg-amber-50 border border-amber-200 p-3 rounded-lg text-amber-800 text-[11px] font-sans shadow-sm">
                      ...
                      <span>
                        In Step 3, you can edit product titles, customize parsed
                        prices, or drop items you do not wish to push onto live
                        counters today.
                      </span>
                    </div>
                  ...
                  >
                    <div className="flex justify-between items-center bg-slate-50 border border-slate-200 p-3 rounded-lg shadow-sm">
                      <span className="text-xs font-bold text-slate-800 font-display flex items-center gap-2">
                        <Cpu className="h-4 w-4 text-[#EA580C]" />
                        <span>
                          Extracted Catalog Preview ({detectedProducts.length}{" "}
                          Items)
                        </span>
                      </span>
                      <span className="text-[10px] font-mono text-slate-400">
                        Click to override items or delete files.
                      </span>
                    </div>

                    {/* Table of items for desktop, cards for mobile */}
                    <div className="space-y-4">
                      <div className="space-y-4 sm:hidden">
                        {detectedProducts.map((p, idx) => (
                          <div
                            key={idx}
                            className="bg-slate-50 border border-slate-200 rounded-3xl p-4 shadow-sm"
                          >
                            <div className="flex flex-col gap-3">
                              <div className="flex items-center justify-between gap-4">
                                <div className="min-w-0">
                                  ...
                                  <input
                                    ...
                                    value={p.name}
                                    onChange={(e) =>
                                      handleEditProductName(idx, e.target.value)
                                    }
                                    className="w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-xs text-slate-900 font-semibold focus:outline-none focus:border-[#EA580C] focus:ring-1 focus:ring-[#EA580C]/35"
                                  />
                                </div>
                                <button
                              ...
                              <div className="grid grid-cols-1 gap-3">
                                <div>
                                  <label className="text-[9px] uppercase font-mono text-slate-500">
                                    Mapped Category
                                  </label>
                                  <div className="mt-1 inline-flex items-center rounded-full bg-orange-50 border border-orange-100 px-2.5 py-1 text-[10px] font-mono text-[#EA580C]">
                                    {p.categoryId}
                                  </div>
                                </div>
                                <div>
                                ...
                                <div>
                                  ...
                                  <div className="mt-1 flex items-center gap-2">
                                    ...
                                    <input
                                      ...
                                      className="w-24 bg-white border border-slate-200 rounded-xl px-2 py-2 text-xs font-mono text-slate-900 focus:outline-none focus:border-[#EA580C] focus:ring-1 focus:ring-[#EA580C]/35"
                                    />
                                  </div>
                                </div>
                              </div>
                          ...
                          <table className="min-w-full text-left border-collapse">
                            <thead>
                              <tr className="bg-slate-100 text-slate-500 font-mono text-[10px] uppercase font-semibold border-b border-slate-200">
                                ...
                                <th className="px-4 py-2.5 w-16 text-center">
                                  Action
                                </th>
                              </tr>
                            </thead>
                            <tbody className="divide-y divide-slate-100 text-xs">
                              {detectedProducts.map((p, idx) => (
                                <tr key={idx} className="hover:bg-slate-50">
                                  ...
                                  <td
                                    className="px-4 py-3 text-slate-400 break-words max-w-xs"
                                    title={p.description}
                                  >
                                    {p.description}
                                  </td>
                ...
                {step === 4 && (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-display font-extrabold text-slate-900">
                      Catalogs Synced Perfectly!
                    </h3>
                    <p className="text-xs text-slate-500 mt-1.5 max-w-md font-light leading-relaxed">
                      Successfully injected the categories and catalog elements
                      from <b>{selectedFile}</b> directly into{" "}
                      <b>{activeRest?.name}'s</b> unified digital storage
                      database.
                    </p>
                    ...
                    <div className="bg-slate-50 border border-slate-100 rounded-xl p-4 mt-6 w-full max-w-sm text-left shadow-sm">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-center">
                        <div className="bg-white p-2.5 rounded-lg border border-slate-150">
                          <span className="text-lg font-bold font-display text-[#EA580C]">
